...
export const mockGoodsReceipts: GoodsReceipt[] = [
  {
    ...
    items: [{ productId: '3', productName: 'Kabl PP-Y 3x2.5mm²', quantity: 200, costPrice: 120, sellingPrice: 150, unit: 'meter' }],
    totalCost: 24000,
  },
  {
    id: 'gr2', supplier: 'Würth Srbija', date: '2026-03-24T10:00:00',
    items: [
      { productId: '1', productName: 'Vijci za drvo 5x50mm', quantity: 1000, costPrice: 2.5, sellingPrice: 3.5, unit: 'piece' },
      { productId: '8', productName: 'Tiple Fischer SX 8x40', quantity: 500, costPrice: 8, sellingPrice: 12, unit: 'piece' },
    ],
    totalCost: 6500,
  },
];
